...
image = tk.PhotoImage(file="./mask.png")#
label = tk.Label(image=image, bg ='gray12')
...
btn = Button(v, text="Activar Detector", bg="red2", fg="white",command=run, font=arial32)
